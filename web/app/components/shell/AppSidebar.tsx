    ...
    >
      <div className={styles.sidebarHead}>
        <Link
          ...
          onClick={onClose}
          aria-label="Crypto Strategy Lab - Realtime"
        >
        ...
        <button
          ...
          aria-label={
            collapsed ? "Mở rộng panel điều hướng" : "Thu gọn panel điều hướng"
          }
        ...
        {navigationItems.map((item) => {
          ...
          const content = (
            <>
              ...
              {!item.available ? <small>Sớm</small> : null}
            </>
          );
          return item.available ? (
            ...
            <span
              ...
              aria-disabled="true"
              title={`${item.label} sẽ được triển khai ở bước tiếp theo`}
            >
              {content}
            </span>
          );
