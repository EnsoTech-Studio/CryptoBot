...
| A07 | [SRC-ADD] | Adaptive news extraction khi DOM thay đổi | `specs/news.md`, `specs/agent-architecture.md` | 13, 25, 30, 33, 38 | Yes | No | No | Deterministic quality-gate fail triggers sanitized-HTML agent; validation/cache test |
